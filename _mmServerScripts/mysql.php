...
if (!function_exists('mysql_connect') || !function_exists('mysql_connect') || !extension_loaded('mysql')){
...
*/
	...
	function GetColumnsOfTable($TableName)
	{
		...
		$result = mysqli_query($con,$query) or $this->HandleException();
	...
	function ExecuteSQL($aStatement, $MaxRows)
	{
		...
		$result = mysqli_query($con,$aStatement) or $this->HandleException();
